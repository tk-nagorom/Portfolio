  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        initial={{ y: '100vw' }} // Start off-screen
      ...
      >
        ...
        <h1 className="text-[40px] md:text-[60px] font-bold text-white mb-2">Otuonye Chinagorom</h1>
        ...
        <p className="text-gray-400 leading-relaxed mb-8 text-sm md:text-base">
          ...
          functional React web applications. <br />I focus on designing digital
          experiences that are user-friendly and visually appealing.
        </p>
